...
class GroovyMarkupTemplateEngineRenderingIntegrationTest  extends org.jbake.template.AbstractTemplateEngineRenderingIntegrationTest {

    GroovyMarkupTemplateEngineRenderingIntegrationTest() {
    ...
    public void renderCustomTypePaper() throws Exception {
        ...
        Renderer renderer = new Renderer(contentStoreSqlite, config);
